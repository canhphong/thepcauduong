...
class ET_Builder_Module_Posts_s extends ET_Builder_Module {

	function init() {
		$this->template_name = 'module-posts';
		$this->name = esc_html__( 'Posts EXTRA', 'et_builder' );
	...
	function get_fields() {
		$fields = array(
			'category_id'                 => array(
				...
				'type'            => 'custom',
				'description'     => esc_html__( 'Choose categories.', 'et_builder' ),
				'renderer'        => array(
					$this,
			...
			'display_featured_posts_only' => array(
				'label'           => esc_html__( 'Display Featured Posts Only', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => esc_html__( 'No', 'et_builder' ),
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				),
				'description'     => esc_html__( 'Only display featured posts.', 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'ignore_displayed_posts' => array(
				'label'           => esc_html__( 'Ignore Displayed Posts', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => esc_html__( 'No', 'et_builder' ),
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				),
				'description'     => esc_html__( 'Do not display posts that have been displayed on previous modules.', 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'heading_style'               => array(
				'label'           => esc_html__( 'Heading Style', 'et_builder' ),
				'type'            => 'select',
				'options'         => array(
					'category' => esc_html__( 'Primary Heading: Category Name, Sub Heading: Filter', 'et_builder' ),
					'filter'   => esc_html__( 'Primary Heading: Filter, Sub Heading: Category Name', 'et_builder' ),
					'custom'   => esc_html__( 'Custom Title', 'et_builder' ),
				),
				'description'     => esc_html__( 'Choose a heading style.', 'et_builder' ),
				'affects'         => array(
			...
			'heading_primary'             => array(
				'label'           => esc_html__( 'Primary Heading', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'The primary heading.', 'et_builder' ),
			...
			'heading_sub'                 => array(
				...
				'type'            => 'input',
				'description'     => esc_html__( 'The sub heading.', 'et_builder' ),
				'depends_show_if' => 'custom',
				'option_category' => 'configuration',
			),
			'posts_per_page'              => array(
				'label'           => esc_html__( 'Posts Limit', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'The number of posts shown.', 'et_builder' ),
				'priority'        => 3,
				'option_category' => 'configuration',
			),
			'orderby'                     => array(
				'label'           => esc_html__( 'Sort Method', 'et_builder' ),
				'type'            => 'select',
				'options'         => array(
					'date'          => esc_html__( 'Most Recent', 'et_builder' ),
					'comment_count' => esc_html__( 'Most Popular', 'et_builder' ),
					'rating'        => esc_html__( 'Highest Rated', 'et_builder' ),
				),
				'description'     => esc_html__( 'Choose a sort method.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'order'                       => array(
				'label'           => esc_html__( 'Sort Order', 'et_builder' ),
				'type'            => 'select',
				'options'         => array(
					'desc' => esc_html__( 'Descending', 'et_builder' ),
					'asc'  => esc_html__( 'Ascending', 'et_builder' ),
				),
				'description'     => esc_html__( 'Choose a sort order.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'show_thumbnails'             => array(
				...
				'description'     => esc_html__( "Turn the display of each post's featured image on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_author'                 => array(
				...
				'description'     => esc_html__( "Turn the display of each post's author on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_categories'             => array(
				...
				'description'     => esc_html__( "Turn the display of each post's categories on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_comments'               => array(
				'label'           => esc_html__( 'Show Comments', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => esc_html__( 'Yes', 'et_builder' ),
					'off' => esc_html__( 'No', 'et_builder' ),
				),
				'description'     => esc_html__( "Turn the display of each post's ccomments on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_rating'                 => array(
				...
				'description'     => esc_html__( "Turn the display of each post's rating on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_date'                   => array(
				...
				'description'     => esc_html__( "Turn the dispay of each post's date on or off.", 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'date_format'                 => array(
				...
				'description'         => esc_html__( 'The format for the date display in PHP date() format', 'et_builder' ),
				'option_category'     => 'configuration',
			),
			...
			'module_id'                   => array(
				...
				'type'            => 'text',
				'description'     => esc_html__( 'Enter an optional CSS ID to be used for this module. An ID can be used to create custom CSS styling, or to create links to particular sections of your page.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'module_class'                => array(
				'label'           => esc_html__( 'CSS Class', 'et_builder' ),
				'type'            => 'text',
				'description'     => esc_html__( 'Enter optional CSS classes to be used for this module. A CSS class can be used to create custom CSS styling. You can add multiple classes, separated with a space.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'max_width'                   => array(
	...
	function category_field_renderer( $field ) {
		...
		$output .= sprintf( '<label><input type="checkbox" name="%1$s" value="%2$s" <%%= _.contains( %4$s, \'%2$s\' ) ? checked=\'checked\' : \'\' %%> > %3$s</label><br/>',
			esc_attr( $name ),
			esc_attr( '-1' ),
			esc_html__( 'Current Category / Tag / Taxonomy', 'et_builder' ),
			esc_attr( $temp_name )
		);
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( ! empty( $this->shortcode_atts['terms_names'] ) ) {
			...
			$category_name = esc_html__( 'All', 'et_builder' );
		}
		...
		switch ( $this->shortcode_atts['orderby'] ) {
			case 'comment_count':
				$filter_title = esc_html__( 'Popular', 'et_builder' );
				break;
			case 'rating':
				$filter_title = esc_html__( 'Top Rated', 'et_builder' );
				break;
			case 'date':
			default:
				$filter_title = esc_html__( 'Latest', 'et_builder' );
				break;
		}
...
new ET_Builder_Module_Posts_s;

class ET_Builder_Module_Tabbed_Posts_s extends ET_Builder_Module {
	...
	function init() {
		...
		$this->name = esc_html__( 'Tabbed Posts EXTRA', 'et_builder' );
	...
	function add_new_child_text() {
		return esc_html__( 'Add New Tab', 'et_builder' );
	}
...
new ET_Builder_Module_Tabbed_Posts_s;

function init_extra_walker_categorydropdown_s() {
	class Extra_Walker_CategoryDropdown_s extends Walker_CategoryDropdown {
...
class ET_Builder_Module_Tabbed_Posts_Tab_s extends ET_Builder_Module_Posts_s {

	function init() {
		$this->template_name = 'module-tabbed-posts-tab';
		$this->name = esc_html__( 'Tab EXTRA', 'et_builder' );
	...
	function get_fields() {
		$fields = array(
			'category_id'                 => array(
				...
				'type'            => 'custom',
				'description'     => esc_html__( 'Choose a category.', 'et_builder' ),
				'renderer'        => array(
					$this,
					'category_field_renderer',
				),
	...
	function category_field_renderer( $field ) {
		if ( !class_exists( 'Extra_Walker_CategoryDropdown_s' ) ) {
			init_extra_walker_categorydropdown_s();
		}
		$dropdown_args = array(
			'echo'            => 0,
			'name'            => $this->get_field_name( $field ),
			'hierarchical'    => 1,
			'show_option_all' => esc_html__( 'All', 'et_builder' ),
			'walker'          => new Extra_Walker_CategoryDropdown_s,
		);
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( empty( $term ) ) {
			$this->shortcode_atts['term_name'] = esc_html__( 'All', 'et_builder' );
...
new ET_Builder_Module_Tabbed_Posts_Tab_s;

class ET_Builder_Module_Posts_Carousel_dwd extends ET_Builder_Module_Posts_s {

	function init() {
		$this->template_name = 'module-posts-carousel';
		$this->name = esc_html__( 'Posts Carousel EXTRA', 'et_builder' );
	...
	function get_fields() {
		...
		$new_fields = array(
			'enable_autoplay'    => array(
				'label'           => esc_html__( 'Enable Autoplay', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => esc_html__( 'No', 'et_builder' ),
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				...
				'description'     => esc_html__( 'Turn the autoplay feature on or off.', 'et_builder' ),
				'priority'        => 6,
				'option_category' => 'configuration',
			),
			'autoplay_speed'     => array(
				...
				'type'            => 'input',
				'depends_show_if' => "on",
				'description'     => esc_html__( 'The speed, in seconds, in which it will auto rotate to the next slide.', 'et_builder' ),
				'priority'        => 6,
				'option_category' => 'configuration',
			),
			'max_title_characters'=> array(
				'label'           => esc_html__( 'Max. Title Characters', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'Length of the title need to be limited to prevent inappropriate caption height in narrow column', 'et_builder' ),
				'option_category' => 'configuration',
			),
...
new ET_Builder_Module_Posts_Carousel_dwd;

class ET_Builder_Module_Featured_Posts_Slider_dwd extends ET_Builder_Module_Posts_Carousel_dwd {

	function init() {
		$this->template_name = 'module-featured-posts-slider';
		$this->name = esc_html__( 'Featured Posts Slider EXTRA', 'et_builder' );
...
new ET_Builder_Module_Featured_Posts_Slider_dwd;

class ET_Builder_Module_Posts_Blog_Feed_s extends ET_Builder_Module_Posts_s {

	function init() {
		$this->template_name = 'module-posts-blog-feed';
		$this->name = esc_html__( 'Blog Feed Standard EXTRA', 'et_builder' );
	...
	function get_fields() {
		...
		$new_fields = array(
			'feed_title'                 => array(
				'label'           => esc_html__( 'Blog Feed Title', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'This is an optional title to display for this module.', 'et_builder' ),
				'priority'        => 2,
				'option_category' => 'configuration',
			),
			'posts_per_page'             => array(
				'label'           => esc_html__( 'Posts Per Page', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'The number of posts shown per page.', 'et_builder' ),
				'priority'        => 3,
				'option_category' => 'configuration',
			),
			'show_pagination'            => array(
				...
				'description'     => esc_html__( 'Turn pagination on or off.', 'et_builder' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_author'                => array(
			...
			'content_length'             => array(
				...
				'options'         => array(
					...
					'full'    => esc_html__( "Show Full Content", 'et_builder' ),
				),
				'affects'         => array(
					'#et_pb_show_more',
				),
				'description'     => esc_html__( "Display the post's exceprt or full content. If full content, then it will truncate to the more tag if used.", 'et_builder' ),
				'option_category' => 'configuration',
			),
			'show_more'                  => array(
...
new ET_Builder_Module_Posts_Blog_Feed_s;

class ET_Builder_Module_Posts_Blog_Feed_Masonry_s extends ET_Builder_Module_Posts_Blog_Feed_s {

	function init() {
		$this->template_name = 'module-posts-blog-feed';
		$this->name = esc_html__( 'Blog Feed Masonry EXTRA', 'et_builder' );
...
new ET_Builder_Module_Posts_Blog_Feed_Masonry_s;

class ET_Builder_Module_Ads_s extends ET_Builder_Module {

	public static $ads_data = array();

	function init() {
		$this->template_name = 'module-ads';
		$this->name = esc_html__( 'Ads EXTRA', 'et_builder' );
		$this->slug = 'et_pb_ads';
		$this->whitelisted_fields = array();
		foreach ( $this->get_fields() as $name => $field ) {
			$this->whitelisted_fields[] = $name;
	...
	function get_fields() {
		$fields = array(
			'header_text'       => array(
				'label'           => esc_html__( 'Header Text', 'et_builder' ),
				'type'            => 'text',
				'description'     => esc_html__( 'Text for the header of the module. Leave blank for no header for the module.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'header_text_color' => array(
				'label'           => esc_html__( 'Header Text Color', 'et_builder' ),
				'type'            => 'color-alpha',
				'description'     => esc_html__( 'This will be used as the text color for the header text of the module.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'border'            => array(
				'label'           => esc_html__( 'Show Top Border?', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => esc_html__( 'No', 'et_builder' ),
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				...
				'description'     => esc_html__( 'This will add a border to the top side of the module.', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'border_color'      => array(
				...
				'type'                => 'color-alpha',
				'depends_show_if_not' => 'off',
				'description'         => esc_html__( 'This will be used as the border color for this module.', 'et_builder' ),
			),
			'admin_label'       => array(
				'label'       => esc_html__( 'Admin Label', 'et_builder' ),
				'type'        => 'text',
	...
	function add_new_child_text() {
		return esc_html__( 'Add New Ad', 'et_builder' );
	}
...
new ET_Builder_Module_Ads_s;

class ET_Builder_Module_Ads_Ad_s extends ET_Builder_Module {

	function init() {
		$this->template_name = '';
		$this->name = esc_html__( 'Ad', 'et_builder' );
	...
	function get_fields() {
		$fields = array(
			'ad_internal_name' => array(
				'label'       => esc_html__( 'Admin Label', 'et_builder' ),
				'type'        => 'input',
				'description' => esc_html__( 'Name displayed internally in builder for this ad', 'et_builder' ),
			),
			'img_url'          => array(
				...
				'description'        => esc_html__( 'URL of the ad image.', 'et_builder' ),
				'option_category'    => 'basic_option',
			),
			'img_alt_text'         => array(
				'label'           => esc_html__( 'Image Alt Text', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'Alternative text for image', 'et_builder' ),
				'option_category' => 'basic_option',
			),
			'link_url'         => array(
				'label'           => esc_html__( 'Link URL', 'et_builder' ),
				'type'            => 'input',
				'description'     => esc_html__( 'URL the ad\'s image links to.', 'et_builder' ),
				'option_category' => 'basic_option',
			),
			'new_line'         => array(
				'label'           => esc_html__( 'Start on New Line?', 'et_builder' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => esc_html__( 'No', 'et_builder' ),
					'on'  => esc_html__( 'Yes', 'et_builder' ),
				),
				'description'     => esc_html__( 'Start the ad\'s output on a new line?', 'et_builder' ),
				'option_category' => 'configuration',
			),
			'content_new'      => array(
				'label'              => esc_html__( 'Ad HTML', 'et_builder' ),
				'type'               => 'tiny_mce',
				'tiny_mce_html_mode' => true,
				'description'        => esc_html__( 'The Ad HTML, if not using the Image URL and Link above.', 'et_builder' ),
				'option_category'    => 'basic_option',
			),
		);
...
new ET_Builder_Module_Ads_Ad_s;
