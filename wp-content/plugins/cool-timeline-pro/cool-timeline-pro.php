    ...
    function ctp_activation_before() {
        ...
        function ctl_option_panel() {
            ...
            $options_panel->TabsListing(array(
                'links' => array(
                    ...
                    'options_11' => __('Content Timeline Settings', 'apc'),
            ...
            //Color field
            $options_panel->addColor('content_bg_color', array('name' => __('Story Background Color', 'apc'), 'std' =>'#f9f9f9', 'desc' => __('', 'apc')));

            $options_panel->addColor('content_color', array('name' => __('Content Font Color', 'apc'),'std' =>'#666666', 'desc' => __('', 'apc')));
            $options_panel->addColor('title_color', array('name' => __('Story Title Color', 'apc'),'std' =>'#fff', 'desc' => __('', 'apc')));

            $options_panel->addColor('circle_border_color', array('name' => __('Circle Color', 'apc'), 'std' =>'#222222', 'desc' => __('', 'apc')));

            $options_panel->addColor('line_color', array('name' => __('Line Color', 'apc'), 'std' =>'#000', 'desc' => __('', 'apc')));
            //Color field
            $options_panel->addColor('first_post', array('name' => __('First Color', 'apc'), 'std' =>'#02c5be', 'desc' => __('', 'apc')));
            $options_panel->addColor('second_post', array('name' => __('Second Color', 'apc'), 'std' =>'#f12945', 'desc' => __('', 'apc')));
            ...
            $options_panel->addTypo('main_title_typo', array('name' => __("Main Title", "apc"), 'std' => array('size' => '22px', 'color' => '#000000', 'face' => 'arial', 'style' => 'normal'), 'desc' => __('', 'apc')));

            $options_panel->addTypo('post_title_typo', array('name' => __("Story Title", "apc"), 'std' => array('size' => '20px', 'color' => '#000000', 'face' => 'arial', 'style' => 'normal'), 'desc' => __('', 'apc')));

            $options_panel->addRadio('post_title_text_style', array('lowercase' => 'Lowercase',
                'uppercase' => 'Uppercase', 'capitalize' => 'Capitalize',
                'none' => 'None'    
                ), array('name' => __('Story Title Style ?', 'apc'), 'std' => array('capitalize'), 'desc' => __('', 'apc')));

            $options_panel->addTypo('post_content_typo', array('name' => __("Story Content", "apc"), 'std' => array('size' => '14px', 'color' => '#000000', 'face' => 'arial', 'style' => 'normal'), 'desc' => __('', 'apc')));
           ...
           $options_panel->addText('post_type_slug', array('name' => __('Custom slug of timeline stories', 'apc'), 'std' => '', 'desc' => __('Remember to save the permalink again in settings -> Permalinks.', 'apc')));
            ...
            $options_panel->addRadio('ctl_slideshow', array('true' => 'Enable',
             ...
             $options_panel->addRadio('ctl_goback', array('true' => 'Enable',
                'false' => 'Disable'), array('name' => __('Show go to back link ?', 'apc'), 'std' => array('true'), 'desc' => __('Show go back to timeline link on single story(detail) page.', 'apc')));
        
            $options_panel->addText('ctl_goback_lbl', array('name' => __('Go Back Link Text', 'apc'), 'std' =>"Go Back", 'desc' => __('Add change Go to back link text', 'apc')));
            ...
            $options_panel->addRadio('disable_months', array('yes' => 'Yes',
                'no' => 'no'), array('name' => __('Disable Stories Dates ?', 'apc'), 'std' => array('no'), 'desc' => __('', 'apc')));
            ...
            $options_panel->addRadio('ctl_date_formats', array('M d' => date('M d'),
                ...
                'm/d/Y' => date('m/d/Y'), 'd/m/Y' => date('d/m/Y')
                    ), array('name' => __('Stories Date Formats ?', 'apc'), 'std' => array('M d'), 'desc' => __('', 'apc')));
            ...
            $options_panel->addTypo('ctl_date_typo', array('name' => __("Stories date Font style", "apc"), 'std' => array('size' => '22px', 'color' => '#000000', 'face' => 'arial', 'style' => 'normal'), 'desc' => __('', 'apc')));
		   ...
		   $options_panel->addColor('ctl_date_color', array('name' => __('Stories date color', 'apc'), 'std' =>'#000000', 'desc' => __('', 'apc')));
            ...
            $options_panel->addRadio('enable_navigation', array('yes' => 'Yes',
                'no' => 'no'), array('name' => __('Enable Scrolling  Navigation ?', 'apc'), 'std' => array('yes'), 'desc' => __('', 'apc')));
            ...
            $options_panel->addRadio('enable_pagination', array('yes' => 'Yes',
                'no' => 'No'), array('name' => __('Enable Pagination ?', 'apc'), 'std' => array('yes'), 'desc' => __('Pagination settings added in shortcode Generator in version 2.4', 'apc')));
           ...
           // $options_panel->addWysiwyg('no_posts', array('name' => __('No Timeline Posts content', 'apc'), 'desc' => __('', 'apc')));
            ...
            //An optionl descrption paragraph
            $options_panel->addParagraph(__('<img src="https://res.cloudinary.com/cooltimeline/image/upload/v1505132504/cool-timeline-pro/timeline_shortcode.png" style="width:100%">', "apc"));
            $options_panel->addParagraph(__('<img style="width:100%" src="https://res.cloudinary.com/cooltimeline/image/upload/v1505132504/cool-timeline-pro/category-based_timeline.png">', "apc"));
		...
		<code><strong>[cool-content-timeline post-type="post" layout="default" skin="default" show-posts="20" order="DESC" icons="NO"]</strong> </code>', "apc"));
           ...
           /**
            ...
            $options_panel->addRadio('post_meta', array(
                'yes' => 'Yes', 'no' => 'No'
                    ), array('name' => __('Display Post Meta (Categries,Tags) ?', 'apc'), 'std' => array('yes'), 'desc' => __('', 'apc')));
       ...
       add_filter('mce_external_plugins', array(&$this, 'ctl_add_tinymce_plugin'));
        ...
        public function clt_meta_boxes() {
            ...
            $my_meta->addText('ctl_story_year',array('name'=> 'Story Year','std'=>date('Y')));
         ...
         /*   $my_meta->addSelect('ctl_story_year', $story_year_list, array('name' =>__('Story Year  <span class="ctl_required">*</span>', 'apc'), 'desc' =>__('<p class="ctl_required">Please select story year.</p>', 'apc'), 
           ...
           //	$my_meta->addDate('ctl_story_year',array('name'=> 'Story Year','desc'=>'des','std'=>date('Y'),'format'=>'yy'));
            ...
            $my_meta->addDate('ctl_story_date', array('name' =>__('Story Date <span class="ctl_required">*</span>','apc'), 'desc' =>__('<p class="ctl_required">Please select story date. <strong>Date Format( mm/dd/yy hh:mm )</strong></p>','apc'),
           ...
           $my_meta->addText('ctl_story_order',array('name' =>__('Order<span class="ctl_required">*</span>', 'apc'), 
                'desc' =>__('<p class="ctl_required">Please enter story Order.</p>', 'apc'),
               'class'=>'custom_based',
                ));
            ...
            $my_meta->addText('story_custom_link',array('name'=>__('Story custom link','apc'),
                'desc' =>__('','apc'))); 
             //Color field
            $my_meta->addColor('ctl_story_color',array('name'=> 'Story Color'));
...
<script type='text/javascript'>
   var ctl_cat_obj = {
    ...
    <style type="text/css">
	.mce-container[aria-label="Add Cool Timeline Shortcode"],.mce-container[aria-label="Add Content Timeline Shortcode"] {margin-top:38px;}
	.mce-container[aria-label="Add Cool Timeline Shortcode"], .mce-container[aria-label="Add Content Timeline Shortcode"] {max-height:100%;}
   ...
   .mce-container[aria-label="Add Cool Timeline Shortcode"] .mce-reset {
	...
	.mce-container[aria-label="Add Cool Timeline Shortcode"] .mce-foot .mce-abs-layout, .mce-container[aria-label="Add Content Timeline Shortcode"] .mce-foot .mce-abs-layout {
    position: fixed;
    background: #ddd;
	top:0;
		}
