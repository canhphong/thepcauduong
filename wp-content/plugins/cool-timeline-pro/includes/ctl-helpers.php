...
function ctl_google_fonts(){
  ...
  function ctl_categories_filters($taxo,$select_cat,$type){
           ...
           if(isset($select_cat) && $select_cat!==''){
            ...
            $taxonomy=$taxo?$taxo:'category';
             ...
             $default_cat='<li><a href="#" class="ct-cat-filters" data-tm-type="'.$type.'" data-action="'.$action.'" data-term-slug="all">'.__('All','cool-timeline').'</a></li>';
            }
            ...
            if (!empty($terms) && !is_wp_error($terms)) {
               ...
               $filters_html.=sprintf( '<li><a data-tm-type="'.$type.'" href="#" data-action="'.$action.'" class="ct-cat-filters '.$active.'" data-term-slug="%1$s">%2$s</a></li>',
                      esc_attr($term->slug),
                      esc_html( $term->name )
                  );
                }
...
function ctl_common_assets(){
 ...
 function clt_conditional_assets($layout='default',$type=''){
