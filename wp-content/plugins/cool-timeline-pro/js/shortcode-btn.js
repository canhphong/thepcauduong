                        ...
                        editor.windowManager.open( {
							...
							},
							{
								...
								},
								{
									type: 'listbox',
									name: 'pagination',
									label: 'Pagination ? (Ajax Load More Is Not Available For Compact Layout)',
									values:pagination
								},
								{
									type: 'listbox',
