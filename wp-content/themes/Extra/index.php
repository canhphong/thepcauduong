	...
	<div class="container">
		<div id="content-area" class="<?php extra_sidebar_class(); ?> clearfix">
			<div class="et_pb_extra_column_main">
				<?php if ( is_search() ) { ?>
                  <img class="alignnone size-full wp-image-2702" src="/wp-content/uploads/2017/11/brn_search2.png" alt="" />
                 <div class="search-header">
					<p class="search-text"><?php printf( esc_html__( 'Search Results for: %s', 'extra' ), get_search_query() ); ?></p>
</div>
